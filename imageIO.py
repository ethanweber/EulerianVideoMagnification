...
def imread(path='in.png', gamma=2.2):
    '''reads a PNG RGB image at path and return a numpy array organized along Y, X, channel.
...
def imreadGrey(path='raw.png'):
    '''reads a PNG greyscale image at path and return a numpy array organized along Y, X.
